...
PBRInfo calculatePBRInputs(vec4 albedoSample, vec3 normal, vec3 cameraPos, vec3 worldPos, vec4 pbrMapSample, uint instanceIndex) {
    PBRInfo pbrInputs;

    MetallicRoughnessDataGPU mat = getMaterialPbrMR(getMaterialId(instanceIndex));
