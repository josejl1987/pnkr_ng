...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        planeCfg.m_fragSpvPath = "shaders/plane_tint.frag.spv";
        ...
        renderer.setRecordFunc([&](const pnkr::renderer::RenderFrameContext& ctx)
        {
            ...
            pnkr::renderer::scene::Transform planeXf;
            // plane is already positioned by vertices (y = -0.6). If you prefer,
            // keep vertices at y=0 and use translation here instead.
