...
namespace pnkr::renderer
{
    ...
    void VulkanContext::initDispatcherPreInstance()
    {
        ...
        m_vkGetInstanceProcAddr = getInstanceProcAddr; // add a member PFN_vkGetInstanceProcAddr
    }
    ...
    void VulkanContext::initDispatcherPostDevice(vk::Device device)
    {
        ...
        auto getDeviceProcAddr =
          m_dynamicLoader.getProcAddress<PFN_vkGetDeviceProcAddr>("vkGetDeviceProcAddr");
        if (!getDeviceProcAddr) {
            throw std::runtime_error("Failed to load vkGetDeviceProcAddr");
        }

        m_dld = vk::detail::DispatchLoaderDynamic(m_instance, m_vkGetInstanceProcAddr, device, getDeviceProcAddr);
    }
