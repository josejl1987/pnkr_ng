...
namespace pnkr::renderer
{
    ...
    void VulkanDevice::createAllocator()
    {
            ...
            !funcs.vkCreateBuffer || !funcs.vkDestroyBuffer)
        {
            throw std::runtime_error(
                "[VulkanDevice] VMA function table is incomplete. Did you call initDispatcherPostDevice()?");
        }
    ...
    void VulkanDevice::immediateSubmit(std::function<void(vk::CommandBuffer)>&& record) const
    {
