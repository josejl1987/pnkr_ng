...
namespace pnkr::renderer
{
    ...
    public:
        ...
        // swapchainImageCount: for render finished semaphores (limit GPU ahead of Display)
        VulkanSyncManager(vk::Device device, uint32_t framesInFlight, uint32_t swapchainImageCount);
        ~VulkanSyncManager();
        ...
        [[nodiscard]] vk::Semaphore imageAvailableSemaphore(uint32_t frameIndex) const {
        ...
        [[nodiscard]] vk::Semaphore renderFinishedSemaphore(uint32_t imageIndex) const {
